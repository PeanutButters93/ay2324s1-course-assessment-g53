  ...
  return (
    <div>
      ...
      >
        ...
        <Grid
          item
          style={{ flex: `0 0 ${dividerPosition}%`, position: "relative" }}
        >
          <Paper elevation={3} style={{ padding: "16px", height: "60%" }}>
            <Typography variant="h5">Problem Title</Typography>
            <Typography variant="subtitle1" color="textSecondary">
              Difficulty: Easy
            </Typography>
            <Typography variant="body1" paragraph>
              Here is the problem description. It should explain what the
              problem is and what the user is expected to do in order to solve
              it.
            </Typography>
          </Paper>
          <Paper elevation={4} style={{ padding: "16px", height: "40%" }}>
            <VideoCall />
          </Paper>
        </Grid>
